...
#             return jsonify({'error': 'No non-empty column titles found.'}), 400
...
#     mode = data.get('mode', 'AND')  # 'AND' or 'OR'
...
#         mask = normalized_col.str.contains(normalized_query, case=False, na=False)
